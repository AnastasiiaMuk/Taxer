...
def assert_no_card():
    try:
        driver.find_element(By.XPATH, '//div[@class="card-body"]//tr[4]/td')
        assert False
    except NoSuchElementException:
        pass


def add_cert(cert_file_name):
    button_add.click()
...
assert alert.text == 'Ошибка при разборе сертификата'
alert.accept()
time.sleep(1)
